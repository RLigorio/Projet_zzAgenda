...
<body>
	...
	<!-- Navbar requirements with login form and language selection. The navbar collapses into a button on a phone -->
	...
	<!-- Display an exemple of what the agenda may look like -->
